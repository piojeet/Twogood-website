...
function navbar() {
  ...
  openMenu.addEventListener("click", function() {
      ...
      icons.classList.toggle("openmenu");
      // alert()
  });
}
navbar();
...
textarea.addEventListener('focus', () => {
  if (textarea.placeholder) {
    ...
    // textarea.style.color = 'black'; // Change text color on click
  }
});

textarea.addEventListener('blur', () => {
  if (!textarea.value) {
    textarea.placeholder = 'ENTER YOUR EMAIL ADDRESS FOR GOOD';
    // textarea.style.color = '#ccc'; // Restore placeholder text color on blur
  }
});
